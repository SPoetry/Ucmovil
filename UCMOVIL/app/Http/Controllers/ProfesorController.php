...
class ProfesorController extends Controller
{
  ...
  public function mostrar_impartidos()  //entrega todos los datos de los ramos impartidos
  {
    $impartidos =   RamosImpartido::all()->where('id_profesor', auth()->user()->id);  //conexion a la base de datos y ordenados
    return $impartidos;  //entrega datos en forma de json
  }
